        ...
        try:   
            ...
            if case == 'naver':                 #네이버쇼핑일때
                for naver_pdp in naver_pdps:
                    ...
                    item['pr1ca'] = cate.css('.top_breadcrumb__yrBH6 > span::text')[1].get()+cate.css('.top_breadcrumb__yrBH6 > span::text')[2].get()+cate.css('.top_breadcrumb__yrBH6 > span::text')[3].get()
                ...
                for naver_pdp in naver_pdps:
                    ...
                    item['pr1va'] = ' '                   
                    item['msbf'] = ' '
                    item['prdetail'] = ' '#naver_pdp.css('.specInfo_section_spec__2KP4f > div::text').get()
                    item['pr1ca'] = ' '
                    # item['pr2ca'] = ' '
                    # item['pr3ca'] = ' '
                    item['dcpr'] =' '
